package com.example.onlinecarparkfinder.ui.main;
...
import com.example.onlinecarparkfinder.ActiveParkingAdapter;
import com.example.onlinecarparkfinder.ParkModel;
import com.example.onlinecarparkfinder.ParkReservationModel;
import com.example.onlinecarparkfinder.R;
import com.example.onlinecarparkfinder.VehicleModel;
 ...
 */
public class OldPlaceholderFragment extends Fragment {
    ...
    public static OldPlaceholderFragment newInstance(int index) {
        OldPlaceholderFragment fragment = new OldPlaceholderFragment();
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_user_parking, container, false);


        lis_active_park = root.findViewById(R.id.lis_active_park);
        txt_message = root.findViewById(R.id.txt_message);
    ...
    public void showOldParking() {


//        final ProgressDialog dialog = ProgressDialog.show(getActivity(), "",
//                "Loading. Please wait...", true);
        String url = getResources().getString(R.string.url) + "userOldParkReservation/" + logPre.getString("user_id", "");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (result.has("reservation")) {
                        ...
                        activeParkingAdapter = new ActiveParkingAdapter(getActivity(), items);
